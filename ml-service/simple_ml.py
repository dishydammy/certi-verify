"""
ProofSkill ML System - Simple Single File Version
Just run: python simple_ml.py
"""
...
OPENROUTER_API_KEY = "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"  # Replace with your actual key
...
app = FastAPI(title="ProofSkill ML System - Simple")

@app.get("/")
async def root():
    return {"message": "ProofSkill ML System is running!", "status": "healthy"}
...
if __name__ == "__main__":
    print("🚀 Starting ProofSkill ML System...")
    print(f"📍 Open: http://localhost:8000")
    print(f"📋 Sample test: http://localhost:8000/sample_test")
